...
function getSeedOpportunities(): ArbitrageOpportunityItem[] {
  ...
  return [
    ...
    {
      matchSlug: 'kariobangi-sharks-vs-tusker-fc',
      homeTeam: 'Kariobangi Sharks', awayTeam: 'Tusker FC', league: 'Kenyan Premier League',
      margin: 0.95,
      bestHomeBookmaker: 'Betika',    bestHomeOdds: jitter(2.45),
      bestDrawBookmaker: 'SportPesa', bestDrawOdds: jitter(3.10),
      bestAwayBookmaker: 'Odibets',   bestAwayOdds: jitter(3.05),
      detectedAt: now,
    },
    {
      matchSlug: 'bandari-vs-kakamega-homeboyz',
      homeTeam: 'Bandari FC', awayTeam: 'Kakamega Homeboyz', league: 'Kenyan Premier League',
      margin: 0.82,
      bestHomeBookmaker: 'Odibets',   bestHomeOdds: jitter(2.10),
      bestDrawBookmaker: 'Betika',    bestDrawOdds: jitter(3.20),
      bestAwayBookmaker: 'SportPesa', bestAwayOdds: jitter(3.70),
      detectedAt: now,
    },
    {
